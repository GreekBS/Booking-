...
function statusShortLabel(cellType: ReturnType<typeof resolveCellState>["type"], label: string): string {
...
export const MonthGridDayCard = memo(function MonthGridDayCard({
  ...
  const overlayItems = useMemo(() => {
    ...
    return buildCellOverlayItems(date, rules, ratePlan, overlays).filter((item) => item.key !== "price");
