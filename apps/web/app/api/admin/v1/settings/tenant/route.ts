...
import { updateTenantSettingsSchema } from "@hcp/validators";
import {
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await getTenantSettingsUseCase.execute(
      actor.tenantId,
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const result = await updateTenantSettingsUseCase.execute(
