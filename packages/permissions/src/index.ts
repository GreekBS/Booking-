...
export const PERMISSIONS = {
  ...
  TASK_READ_TENANT: "task:read:tenant",
  TASK_READ_ASSIGNED: "task:read:assigned",
  TASK_CREATE_TENANT: "task:create:tenant",
  TASK_CREATE_ASSIGNED: "task:create:assigned",
  TASK_UPDATE_TENANT: "task:update:tenant",
  TASK_UPDATE_ASSIGNED: "task:update:assigned",
  TASK_ASSIGN_TENANT: "task:assign:tenant",
  HOUSEKEEPING_UPDATE_TENANT: "housekeeping:update:tenant",
  HOUSEKEEPING_UPDATE_ASSIGNED: "housekeeping:update:assigned",
...
export const ROLE_PERMISSIONS: Record<TenantRole, readonly Permission[]> = {
  admin: [
    ...
    PERMISSIONS.TASK_CREATE_TENANT,
    PERMISSIONS.TASK_UPDATE_TENANT,
  ...
  manager: [
    ...
    PERMISSIONS.TASK_CREATE_ASSIGNED,
